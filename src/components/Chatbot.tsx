...
export const Chatbot: React.FC = () => {
  ...
  >([
    {
      role: "bot",
      text: "Hi! I'm Manish's AI assistant. Ask me anything about his skills, projects, or experience!",
    },
  ]);
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 sm:bottom-20 right-0 w-[calc(100vw-2rem)] sm:w-96 h-135 max-h-[70vh] bg-bg/95 backdrop-blur-xl rounded-2xl flex flex-col overflow-hidden border border-white/10 shadow-2xl"
          >
            {/* Header */}
            <div className="p-4 bg-primary/10 border-b border-white/10 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-primary">Online & Ready</p>
                </div>
              </div>
              <button
      ...
      <button
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-primary flex items-center justify-center text-bg shadow-[0_0_20px_rgba(0,255,65,0.4)] hover:scale-110 transition-transform active:scale-95"
      >
